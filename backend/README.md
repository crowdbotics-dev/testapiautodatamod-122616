...
## Project Structure
    ...
    ├── testapiautodatamod_122616  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_122616`
...
2. Clone this repo and `cd testapiautodatamod_122616`
